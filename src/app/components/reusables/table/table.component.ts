...
export class TableComponent implements OnInit {
  public tableContainer =
    viewChild<ElementRef<HTMLDivElement>>('tableContainer');
   ...
   */
  public notFoundPlaceholder = input(
    'Nem található a szürésnek megfelelő sorok!',
  );
  ...
  public operationClick = output<{
    row: ITableRow;
    operationName: TableOperationEnum;
  }>();

  public readonly OPERATIONS: Record<
    TableOperationEnum | any,
    { icon: IconIds; class: string }
  > = {
    [TableOperationEnum.DELETE]: { icon: IconIds.TRASH, class: 'label-danger' },
    [TableOperationEnum.EDIT]: {
      icon: IconIds.PENCIL_SQUARE,
      class: 'label-primary',
    },
    [TableOperationEnum.CANCEL]: {
      icon: IconIds.X_CIRCLE,
      class: 'label-danger',
    },
    [TableOperationEnum.CHECK]: {
      icon: IconIds.CHECK_CIRCLE,
      class: 'label-success',
    },
  ...
  public onOperationClick(
    row: ITableRow,
    operation: TableCellOperationType,
  ): void {
